...
const Produtos: React.FC = () => {
  ...
  const [ordemPreco, setOrdemPreco] = useState<string>("desc");
  ...
  function handleOpenForm(produto: Produto | null = null) {
  ...
  async function handleSubmit(form: Produto) {
  ...
  const produtosFiltrados = produtos
    .filter(p =>
      (!filtroTitulo || (p.nome || '').toLowerCase().includes(filtroTitulo.toLowerCase())) &&
